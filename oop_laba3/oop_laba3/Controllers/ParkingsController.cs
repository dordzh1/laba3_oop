...
namespace oop_laba3.Controllers
{
    public class ParkingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Price")] Parking parking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price")] Parking parking)
        {
            if (id != parking.Id)
            {
                return NotFound();
